...
<link href='logo/smk.png' rel='SHORTCUT ICON'/></head>
...
<div id="luar">
    ...
    <?php }
	else if($_SESSION['type_user']=="Siswa")
	{ ?>
    ...
    <nav>
    	<ul>
			...
			{
			?>
        	<a href="halaman_utama.php?tabel_nilai=$tabel_nilai"><li>NILAI</li></a>
            <?php }
			else if($_SESSION['type_user']=="Siswa" )
			{
			?>
            <a href="halaman_utama.php?informasi_nilai=$informasi_nilai"><li>NILAI</li></a>
            <?php } ?>
            <?php
			if($_SESSION['type_user']!="Siswa" )
			{
			?>
        	<a href="halaman_utama.php?tabel_wali_murid=$tabel_wali_murid"><li>WALI MURID</li></a>
            <?php }
			else if($_SESSION['type_user']=="Siswa" )
			{
			?>
            <a href="halaman_utama.php?informasi_walimurid=$informasi_walimurid"><li>WALI MURID</li></a>
            <?php } ?>
            <?php
			if($_SESSION['type_user']!="Siswa" )
			{
			?>
            <a href="halaman_utama.php?tabel_siswa=$tabel_siswa"><li>SISWA</li></a>
            <?php }
            else if($_SESSION['type_user']=="Siswa" )
			{
			?>
            <a href="halaman_utama.php?informasi_siswa=$informasi_siswa"><li>SISWA</li></a>
            <?php } ?>
            <?php if($_SESSION['type_user']=="Admin" )
			{ ?>
            <a href="halaman_utama.php?tabel_guru=$tabel_guru"><li>GURU</li></a>
			<?php }
			else if($_SESSION['type_user']=="Guru" )
			{ ?>
            <a href="halaman_utama.php?informasi_guru=$informasi_guru"><li>GURU</li></a>
            <?php } ?>
            <?php
			if($_SESSION['type_user']=="Admin" )
			{ ?>
        	<a href="halaman_utama.php?tabel_standar_kompetensi=$tabel_standar_kompetensi"><li>STANDAR KOMPETENSI</li></a>
            <?php }
			else if($_SESSION['type_user']=="Guru" )
			{ ?>
            <a href="halaman_utama.php?tabel_standar_kompetensi_untuk_guru=$tabel_standar_kompetensi_untuk_guru"><li>STANDAR KOMPETENSI</li></a>
            <?php } ?>
            <?php if($_SESSION['type_user']!="Siswa")
			{ ?>
            <a href="halaman_utama.php?tabel_jurusan=$tabel_jurusan"><li>JURUSAN</li></a>
            <?php } ?>
            <a href="halaman_utama.php?tabel_mapel=$tabel_mapel"><li>MATA PELAJARAN</li></a>
            <?php
			if($_SESSION['type_user']=="Admin")
			{
			?>
